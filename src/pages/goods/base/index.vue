<template>
  <div class="goods">
    ...
    <van-goods-action>
      <van-goods-action-icon icon="chat-o" @click="sorry" text="我的"></van-goods-action-icon>
      <van-goods-action-icon icon="cart-o" @click="onClickCart" text="购物车"></van-goods-action-icon>
